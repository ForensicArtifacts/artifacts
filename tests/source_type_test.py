...
class SourceTypeFactoryTest(test_lib.BaseTestCase):
    ...
    def testCreateSourceType(self):
        ...
        with self.assertRaises(errors.FormatError):
            source_object = source_type.SourceTypeFactory.CreateSourceType("test", {})

        with self.assertRaises(errors.FormatError):
            source_object = source_type.SourceTypeFactory.CreateSourceType("bogus", {})
    ...
    def testRegisterSourceType(self):
        ...
        self.assertEqual(number_of_source_types, expected_number_of_source_types + 1)
